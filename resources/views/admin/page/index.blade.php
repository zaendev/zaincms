            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <a href="{{ url('admz/page/create') }}" class="btn btn-default">Add New</a>
                        ...
                        <table class="table table-hover">
                            ...
                            @foreach( $data as $key => $d )
                                <tr style="font-style: {{ $d->status == 0 ? ' italic':'' }}">
                                    ...
                                    <td>{{ ucwords($d->template) }}</td>
                                    <td>{{ $d->created_at }}</td>
                                    <td class="no">
                                        <a href="{{ url('admz/page/'.$d->id.'/edit') }}" title="Edit">
                                            <i class="fa fa-edit"></i>
                                        </a>

                                        <form style="display: inline" action="{{ url('admz/page/'.$d->id)}}"
                                              method="post">
