...
@section('content')
    ...
    <section class="content">
        ...
        <form method="post" action="{{ url('admz/slide/'.$data->id) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="row">
                <div class="col-md-8">
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <div class="custom-control custom-radio">
                                    <input type="radio" id="publish" name="publish"
                                           {{ $data->status == 1 ? 'checked':'' }} class="custom-control-input"
                                           value="1">
                                    <label class="custom-control-label" for="publish">Publish</label>
                                </div>
                                <div class="custom-control custom-radio">
                                    <input type="radio" id="draft" name="publish"
                                           {{ $data->status == 0 ? 'checked':'' }} class="custom-control-input"
                                           value="0">
                        ...
                        <div class="card-footer">
                            <button type="submit" id="saveDataMenu" class="btn btn-primary float-right">Publish
                            </button>
                        </div>
                    </div>
